	...
	describe('validations', () => {
		...
		describe('indentation', () => {
			...
			describe('tabs', () => {
				...
				it('should pass', () => {
					const file = __fromFixtures('file.indentation.tabs.example');
				...
				it('should report spaces', () => {
					const file = __fromFixtures('file.indentation.mixed.example');
					const validator = new Validator({indentation: 'tabs'});
					validator.validate(file);
				...
				it('should pass file with allowed BOM', () => {
					const file = __fromFixtures('file.indentation.tabs.bom.example');
					const validator = new Validator({
						indentation: 'tabs',
						allowsBOM: true,
					});
			...
			describe('spaces', () => {
				...
				it('should pass', () => {
					const file = __fromFixtures('file.indentation.spaces.example');
				...
				it('should report incorrect', () => {
					const file = __fromFixtures('file.indentation.spaces.invalid.example');
					const validator = new Validator({
						indentation: 'spaces',
						spaces: 4,
					});
				...
				it('should pass file with allowed BOM', () => {
					const file = __fromFixtures('file.indentation.spaces.bom.example');
					const validator = new Validator({
						indentation: 'spaces',
						allowsBOM: true,
					});
			...
			describe('guess', () => {
				...
				it('should guess incorrect using tabs', () => {
					const file = __fromFixtures('file.indentation.guess.tabs.example');
					const validator = new Validator({
						indentation: 'tabs',
				...
				it('should guess incorrect using spaces', () => {
					const file = __fromFixtures('file.indentation.guess.spaces.example');
					const validator = new Validator({
						indentation: 'spaces',
						spaces: 4,
						indentationGuess: true,
				...
				it('should skip newlines', () => {
					const file = __fromFixtures('file.indentation.guess.newline.example');
					const validator = new Validator({
						indentation: 'tabs',
						indentationGuess: true,
					});
		...
		describe('ignores', () => {
			...
			describe('build in', () => {
				...
				it('should ignore indentaion', () => {
					const file = __fromFixtures('file.ignores.buildin.js.example');
					const validator = new Validator({
						indentation: 'tabs',
						ignores: ['js-comments'],
					});
			...
			describe('user defined', () => {
				...
				it('should ignore indentaion', () => {
					const file = __fromFixtures('file.ignores.userdefined.example');
					const validator = new Validator({
						indentation: 'tabs',
						ignores: [
